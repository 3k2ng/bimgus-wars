...
nextstmt
        dc.w 0
; assembly program
        jsr playerExplosion     ; play player explosion sound
        jsr enemyExplosion      ; play enemy explosion sound
        jsr shootBullet         ; play shoot bullet sound
        jsr shootRock           ; play shoot rock sound
        rts
...
; check if we should exit on this note
        cmp #0                  ; compare current volume with final volume
        beq exit                ; if volume is 0, exit the main loop
