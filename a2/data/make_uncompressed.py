# convert .bin files into assembly source code
import sys
...
with open(f"{data_dir}/uncompressed_data.s", "w") as f:
    ...
    with open(f"{data_dir}/char_map.bin", "rb") as fi:
        char_map = fi.read()

    with open(f"{data_dir}/color_map.bin", "rb") as fi:
        color_map = fi.read()

    f.write("uncompressed_char_set\n")
    ...
    f.write("uncompressed_char_set_end\n")

    f.write("uncompressed_char_map\n")
    ...
    f.write("uncompressed_char_map_end\n")

    f.write("uncompressed_color_map\n")
    ...
    f.write("uncompressed_color_map_end\n")
