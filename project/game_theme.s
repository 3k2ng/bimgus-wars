...
; decrease velocity by 1
        ...
        bne skip                ; we don't want the velocity to go below 0!
...
backToMain
        ...
        bne nextY               ; if at least one channel should be playing, skip this next bit
        sta bitmaskOffset       ; if none, store 0 in the offset "register" so the song loops
nextY
